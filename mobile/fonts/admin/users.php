...
<body>
    ...
    <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
        <ul>
            ...
            <li> <a href="protypes.html"><i class="icon icon-th-list"></i> <span>Product type</span></a></li>
                                ...
                                <?php
                                    ...
                                    ?>
                                     <tr class="">
                                            ...
                                            <td><?php echo  md5($value['pass'])?></td>
                                            <td><?php echo $value['role_id'] ?></td>

                                            <td>
                                            <a href="form_update.php?functionUser=user&user_id=<?php echo $value['user_id']; ?>" class="btn btn-success btn-mini">Edit</a>
                                                <a href="delete-user.php?user_id=<?php echo $value['user_id']; ?>" class="btn btn-danger btn-mini">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                        }
