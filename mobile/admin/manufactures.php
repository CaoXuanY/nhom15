                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $page = 1;
                                        $resultsPerPage = 5;
                                        $totalResults = count(Manufacture::getAllManufacturers());
                                        // $totalLinks = ceil($totalResults/$resultsPerPage);
                                        if(isset($_GET['page'])==TRUE) {
                                            $page = $_GET['page'];
                                        }
                                        $list_of_manufacturers = Manufacture::getAllManufacturers_andCreatePagination($page, $resultsPerPage);
                            ...
                            <div class="row" style="margin-left: 18px;">
                                <ul class="pagination">
                                    <?php
                                        echo Manufacture::paginate("manufactures.php?", $page, $totalResults, $resultsPerPage, 1);
                                    ?>
                                </ul>
                            </div>
                        </div>
