...
//     echo "<script>alert('Chào  ".$_SESSION['user']."')</script>";
// }
// else{
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget-box">
                                ...
                                <?php
                                    ...
                                    if(isset($_GET['insertResult']) == TRUE) {
                                        if($_GET['insertResult'] > 0) {
                                            echo "<span style=\"color:green;\">" . "Đã thêm sản phẩm thành công" . "</span>";
                                        }
                                        else {
                        ...
                        ?>
                        <!-- BEGIN USER FORM -->
                        <form action="insert_manufacturer.php" method="get" class="form-horizontal"
                            enctype="multipart/form-data">
                            <div class="control-group">
                        ...
                        <div style="padding:30px 0;text-align:center;font-weight:bold;font-size:15px;">
                            <?php
                                ...
                                if(isset($_GET['insertResult']) == TRUE) {
                                    if($_GET['insertResult'] > 0) {
                                        echo "<span style=\"color:green;\">" . "Đã thêm hãng thành công." . "</span>";
                                    }
                                    else {
                                        echo "<span style=\"color:red;\">" . "Thêm hãng thất bại!" . "</span>";
                                    }
                                }
                            ?>
                        </div>
                        ...
                        ?>
                        <!-- BEGIN USER FORM -->
                        <form action="insert_protype.php" method="get" class="form-horizontal"
                            enctype="multipart/form-data">
                            <div class="control-group">
                        ...
                        <div style="padding:30px 0;text-align:center;font-weight:bold;font-size:15px;">
                            <?php
                                ...
                                if(isset($_GET['insertResult']) == TRUE) {
                                    if($_GET['insertResult'] > 0) {
                                        echo "<span style=\"color:green;\">" . "Đã thêm loại sản phẩm thành công." . "</span>";
                                    }
                                    else {
                                        echo "<span style=\"color:red;\">" . "Thêm loại sản phẩm thất bại!" . "</span>";
                                    }
                                }
                            ?>
                        </div>
