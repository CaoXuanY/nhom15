...
<?php
    ...
    if(isset($_POST['name']) == TRUE && $validFile == TRUE) {
        ...
        //kiem tra sua san pham

        // if(count(Product::insertProduct($_GET[$name], $_GET[$manu_id],$_GET[$type_id],$_GET[$price],$_GET[$pro_image],$_GET[$description],$_GET[$feature], $_GET[$create_at])) == 0) {
    ...
    header("Location: index.php?functionType=products&insertResult=$insertResult");
?>
